--TEST--
Test Uri\WhatWg\UrlBuilder::build() - error - validation warnings assigned to typed property reference with base URL
--XFAIL--
not yet: validation errors are not returned correctly with a base URL
--FILE--
<?php
